...
<div class="template-buttons">
  <a class="template-btn placeholder" href="https://xanthan-web.github.io/alexandra-ruiz/" aria-disabled="true">Live example</a>
  <a class="template-btn" href="https://xanthan-web.github.io/portfolio-template" target="_blank">View template</a>
  <a class="template-btn primary" href="https://github.com/xanthan-web/portfolio-template" target="_blank">Use this template</a>
</div>
{% endcapture %}
...
<div class="template-buttons">
  ...
  <a class="template-btn primary" href="https://github.com/xanthan-web/class-project-template" target="_blank">Use this template</a>
</div>
{% endcapture %}
...
<div class="template-buttons">
  ...
  <a class="template-btn primary" href="https://github.com/xanthan-web/scrollstory-template" target="_blank">Use this template</a>
</div>
{% endcapture %}
