...
The idea is you make a copy of your GitHub repository on your computer, edit the files in a text editor, and then send them to GitHub to actually update the functioning website.
...
GitHub Desktop provides a clear visual history of your changes.
You always know:
